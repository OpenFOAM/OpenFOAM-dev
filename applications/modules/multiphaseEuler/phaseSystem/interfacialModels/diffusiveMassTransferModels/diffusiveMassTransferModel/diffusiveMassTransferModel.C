...
namespace Foam
{
    ...
    defineBlendedInterfacialModelTypeNameAndDebug
    (
        sidedDiffusiveMassTransferModel,
        0
    );
...
Foam::blendedDiffusiveMassTransferModel::K() const
{
    return
        ...
        (
            ...
            "K",
            diffusiveMassTransferModel::dimK
        );
}


Foam::tmp<Foam::volScalarField>
Foam::sidedDiffusiveMassTransferModel::KinThe(const phaseModel& phase) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::blendedSidedDiffusiveMassTransferModel::KinThe
(

...
#include "segregated_blendingMethod.H"
...
Foam::tmp<Foam::volScalarField> Foam::blendingMethods::segregated::fDisplaced
(
    const UPtrList<const volScalarField>& alphas,
...
bool Foam::blendingMethods::segregated::functionOfAlphas() const
{
    return true;
}

...
:
    ...
    rhoLiquid_(dict.lookup<scalar>("rhoLiquid", dimensions::density)),
    liquidSurfacePressure_
    (
        dict.lookup<scalar>("liquidSurfacePressure", dimensions::pressure)
    ),
    liquidSurfacePoint_
    (
        dict.lookup<vector>("liquidSurfacePoint", dimensions::length)
    )
{}

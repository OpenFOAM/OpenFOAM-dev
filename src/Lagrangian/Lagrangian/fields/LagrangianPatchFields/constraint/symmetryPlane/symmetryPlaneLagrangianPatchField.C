...
#include "symmetryPlaneLagrangianPatchField.H"
...
template<class Type>
Foam::symmetryPlaneLagrangianPatchField<Type>::symmetryPlaneLagrangianPatchField
(
...
Foam::symmetryPlaneLagrangianPatchField<Type>::symmetryPlaneLagrangianPatchField
(
    const symmetryPlaneLagrangianPatchField<Type>& ptf
)
:

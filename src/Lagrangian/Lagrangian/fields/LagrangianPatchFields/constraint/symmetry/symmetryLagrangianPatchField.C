...
#include "symmetryLagrangianPatchField.H"
...
template<class Type>
Foam::symmetryLagrangianPatchField<Type>::symmetryLagrangianPatchField
(
...
Foam::symmetryLagrangianPatchField<Type>::symmetryLagrangianPatchField
(
    const symmetryLagrangianPatchField<Type>& ptf
)
:
...
template<class Type>
void Foam::symmetryLagrangianPatchField<Type>::evaluate
(
    PstreamBuffers&,

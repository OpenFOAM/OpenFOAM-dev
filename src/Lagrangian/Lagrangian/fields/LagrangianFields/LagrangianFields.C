...
#define DEFINE_LAGRANGIAN_CAPTALIZED_TYPE_FIELDS(Type)                         \
    DEFINE_LAGRANGIAN_CAPTALIZED_TYPE_FIELDS_(Type)

#define DEFINE_LAGRANGIAN_TYPE_FIELDS(Type, nullArg)                           \
    DEFINE_LAGRANGIAN_CAPTALIZED_TYPE_FIELDS(CAPITALIZE(Type))

DEFINE_LAGRANGIAN_TYPE_FIELDS(label, );
FOR_ALL_FIELD_TYPES(DEFINE_LAGRANGIAN_TYPE_FIELDS);

#undef DEFINE_LAGRANGIAN_CAPTALIZED_TYPE_FIELDS_
#undef DEFINE_LAGRANGIAN_CAPTALIZED_TYPE_FIELDS
#undef DEFINE_LAGRANGIAN_TYPE_FIELDS

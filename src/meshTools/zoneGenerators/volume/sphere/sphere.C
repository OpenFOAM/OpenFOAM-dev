...
inline bool Foam::zoneGenerators::sphere::contains(const point& p) const
{
    return magSqr(centre_ - p) <= radiusSqr_;
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::zoneGenerators::sphere::sphere
(
    const word& name,
    const polyMesh& mesh,
...
Foam::zoneSet Foam::zoneGenerators::sphere::generate() const
{

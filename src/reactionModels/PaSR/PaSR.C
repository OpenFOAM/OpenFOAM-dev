...
namespace reactionModels
{
    ...
    addToRunTimeSelectionTable(reactionModel, PaSR, dictionary);
}
}
...
:
    laminar(modelType, thermo, turb, reactionProperties),
...
void Foam::reactionModels::PaSR::correct()
{
    laminar::correct();
...
Foam::reactionModels::PaSR::R(volScalarField& Y) const
{
...
bool Foam::reactionModels::PaSR::read()
{
    if (laminar::read())
    {

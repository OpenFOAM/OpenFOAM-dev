...
void Foam::reactionModels::singleStepReaction::calculateqFuel()
{
    ...
    Info << "Fuel heat of reaction: " << qFuel_.value() << endl;
}


void Foam::reactionModels::singleStepReaction::massAndAirStoichRatios()
{
...
void Foam::reactionModels::singleStepReaction::calculateMaxProducts()
{
    scalar Wm = 0.0;
    scalar totalMol = 0.0;
    forAll(reaction_.rhs(), i)
...
Foam::reactionModels::singleStepReaction::singleStepReaction
(
...
Foam::reactionModels::singleStepReaction::R(volScalarField& Y) const
{
    const label specieI = thermo_.species()[Y.member()];

    volInternalScalarField wSpecie
    (
...
bool Foam::reactionModels::singleStepReaction::read()
{
...
void Foam::reactionModels::singleStepReaction::fresCorrect()
{
    const label O2Index = thermo_.species()["O2"];

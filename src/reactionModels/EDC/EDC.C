...
namespace reactionModels
{
    ...
    addToRunTimeSelectionTable(reactionModel, EDC, dictionary);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::reactionModels::EDC::EDC
(
...
void Foam::reactionModels::EDC::correct()
{
...
bool Foam::reactionModels::EDC::read()
{

...
{
    defineTypeNameAndDebug(greyMeanReaction, 0);
...
Foam::radiationModels::absorptionEmissionModels::greyMeanReaction::
greyMeanReaction
(
...
Foam::radiationModels::absorptionEmissionModels::greyMeanReaction::ECont
(
    const label bandI
) const
{

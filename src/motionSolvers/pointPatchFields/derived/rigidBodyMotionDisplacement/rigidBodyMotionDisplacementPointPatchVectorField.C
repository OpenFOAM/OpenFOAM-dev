...
#include "rigidBodyMotionDisplacementPointPatchVectorField.H"
...
rigidBodyMotionDisplacementPointPatchVectorField::
rigidBodyMotionDisplacementPointPatchVectorField
(
    const pointPatch& p,
...
rigidBodyMotionDisplacementPointPatchVectorField
(
    const rigidBodyMotionDisplacementPointPatchVectorField& ptf,
    const pointPatch& p,
    const DimensionedField<vector, pointMesh>& iF,
...
const pointField&
rigidBodyMotionDisplacementPointPatchVectorField::localPoints0() const
{
...
void rigidBodyMotionDisplacementPointPatchVectorField::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void rigidBodyMotionDisplacementPointPatchVectorField::
